<template>
    <div class="trafficPDT">
        ...
        <div class="btns">
            ...
            <div class="policeCode">警号：{{data.no?data.no:"[未知]"}}</div>
        ...
        .caozuo{
            ...
            a{
                ...
                .call {
                    ...
                    width: 34px;
                    height: 34px;
                    background: url("../images/trafficPDT/call1.png");
                }
                .conversation {
                    display: block;
                    width: 34px;
                    height: 34px;
                    background: url("../images/trafficPDT/Conversation1.png");
                }
                &:hover {
                    .call {
                        background: url("../images/trafficPDT/call2.png");
                    }
                    .conversation {
                        background: url("../images/trafficPDT/Conversation2.png");
                    }
                }
            }
        }
