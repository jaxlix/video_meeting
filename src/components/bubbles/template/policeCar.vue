<template>
  <div class="policeCar">
    ...
    <div class="msg">
      <img src="../images/policeCar/car-bg.png" alt />
      <p class="name font14">{{ data.carNo ? data.carNo : '[未知]'}}</p>
      <p class="ssfj">{{ data.carOccupant ? data.carOccupant : '[未知]'}}</p>
        ...
        <ul class="btns-ul">
          ...
          >
            <div v-if="d.type == 'POLICEMAN'" class="img-box">
              <img src="../images/policeCar/icon_policeman.png" alt />
              <div class="mj-title">李明</div>
            </div>
            <div v-else-if="d.type == 'MONITORBALL'" class="img-box">
              <img src="../images/policeCar/icon_bukongqiu.png" alt />
